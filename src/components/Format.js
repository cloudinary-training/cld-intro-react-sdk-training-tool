  ...
  return (
    <div>
      ...
      <p>Add f_auto: <a target="_blank" href={cldVideoAutoFormat.toURL()}>{cldVideoAutoFormat.toURL()}</a></p>
        <AdvancedVideo controls height="300px" cldVid={cldVideoAutoFormat} />
      <p>GIF: <a target="_blank" href={cldGIF.toURL()}>{cldGIF.toURL()}</a></p>
        <AdvancedImage  height="300px" cldImg={cldGIF} />
    </div>
  )
}`;
...
cldImage.format("png");`}
  ...
  <AdvancedVideo controls height="300px" cldVid={cldGIFToVideo} />`}
        experimentTitle={
