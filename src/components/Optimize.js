...
export default function App() {
  ...
  return (
    ...
    <AdvancedImage height="400" cldImg={cldImage} />
    <p> <a target="_blank" rel="noreferrer" href={cldImageOptimize.toURL()}>{cldImageOptimize.toURL()}</a></p>
    <AdvancedImage height="400" cldImg={cldImageOptimize} />
    </div>
  )
}`;
...
export default function App() {
  ...
  return (
    ...
    <AdvancedVideo controls height="400" cldVid={cldVideo} />
    <p> <a target="_blank" rel="noreferrer" href={cldVideoOptimize.toURL()}>{cldVideoOptimize.toURL()}</a></p>
    <AdvancedVideo controls height="400" cldVid={cldVideoOptimize} />
    </div>
  )
}`;
